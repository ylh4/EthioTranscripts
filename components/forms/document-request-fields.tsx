...
import type { DocumentRequestFormData } from "./document-request-schema"
import { UniversityLocationFields } from "./fields/university-location-fields"
...
export function DocumentRequestFields({ form }: DocumentRequestFieldsProps) {
  ...
  // Reset otherUniversity when fromUniversity changes to a non-other option
  useEffect(() => {
    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>To University</FormLabel>
              <FormControl>
                <Input placeholder="Destination university name" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
